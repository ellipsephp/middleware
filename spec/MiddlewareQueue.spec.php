    ...
    describe('->process()', function () {
        ...
        context('when the middleware queue is not empty', function () {
            ...
            context('when all middleware implements MiddlewareInterface', function () {
                ...
                it('should process the middleware as a queue then handle the given request with the given request handler', function () {
                    ...
                    $middleware = new MiddlewareQueue([$middleware1, $middleware2]);
